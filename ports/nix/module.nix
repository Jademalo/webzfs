      ...
      extraRules = [
        {
          ...
          commands = map (cmd: { command = cmd; options = [ "NOPASSWD" ]; }) [
            ...
            "systemctl"
            "crontab"
            "tee /etc/systemd/system/webzfs-syncoid-job-*"
            "rm -f /etc/systemd/system/webzfs-syncoid-job-*"
            "tee /etc/systemd/system/webzfs-task-*"
            "rm -f /etc/systemd/system/webzfs-task-*"
            "cat"
            "tee"
            "mkdir"
            "dmesg"
